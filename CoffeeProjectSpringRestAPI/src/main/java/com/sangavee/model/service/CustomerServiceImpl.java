...
public class CustomerServiceImpl implements CustomerService {
	...
	@Override
	public Customer addCustomer(String customerName, long phoneNumber) {
		return customerDao.addCustomer(customerDao.getMaxCustomerId()+1, customerName, phoneNumber);
	}
